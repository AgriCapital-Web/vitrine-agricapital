...
const FoncierContent = () => (
  <>
    <section className="py-20"><div className="container mx-auto grid gap-10 px-4 lg:grid-cols-2 lg:items-center"><img src={potentielAgricole} alt="Mains d'agriculteur tenant une terre fertile au coucher du soleil" className="h-[460px] w-full rounded-xl object-cover shadow-strong" /><div><p className="belife-eyebrow">Le paradoxe</p><h2 className="mb-6 text-3xl font-bold md:text-5xl">Un continent riche de terres. Des familles appauvries faute de pouvoir les valoriser.</h2><p className="text-lg leading-8 text-muted-foreground">En Afrique, des familles possèdent des dizaines d'hectares de terres à fort potentiel agronomique, sur des plateaux fertiles et dans des zones agricoles favorables. Pourtant, ces terres ne produisent rien, ne génèrent aucun revenu et attendent patiemment d'être valorisées et transformées.</p><p className="mt-5 font-bold text-primary">Ce n'est pas un manque de terres.<br />C'est un manque d'accès à la bonne structure.</p></div></div></section>
